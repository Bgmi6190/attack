...
TOKEN = '7240922013:AAH540roa4sh63iTog0HA9O5jot8-E2byYY'
CHANNEL_ID = -1002172184452
ADMIN_ID = -1002172184452
...
def handle_message(message):
    if message.text == "VIP Plan 💥":
        ...
        bot.reply_to(message, "*How to DDos ==> https://t.me/Danger_hack_ddos*", parse_mode='Markdown')
